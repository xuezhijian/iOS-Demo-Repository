...
@class BDAttributedLabelURL;

@interface BDAttributedLabel : UIView

@property (nonatomic,weak)      id<BDAttributedLabelDelegate> delegate;
...
- (void)appendImage: (UIImage *)image
            maxSize: (CGSize)maxSize
             margin: (UIEdgeInsets)margin
          alignment: (BDImageAlignment)alignment;
